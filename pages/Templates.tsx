      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 text-lg max-w-2xl mx-auto">
            Choose from our professionally curated collection of high-conversion templates.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-between items-center mb-12">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-200 rounded-2xl pl-11 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all shadow-sm"
            />
          </div>
        </div>
        ...
        <div className="mt-24 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="max-w-xl">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-4">Need something unique?</h2>
            <p className="text-slate-600 text-lg">
              Our award-winning design team can create a custom, high-end website tailored specifically to your brand identity and business requirements.
            </p>
          </div>
